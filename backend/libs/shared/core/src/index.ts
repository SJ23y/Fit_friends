...
export { TRAIN_TYPES, TrainDuration, DEFAULT_TRAIN_RATE, MAX_TRAINING_COUNT_LIMIT, MAX_REVIEW_COUNT_LIMIT } from './settings/train.setting';
...
export { PaymentType, DEFAULT_PAGE_NUMBER, AUTH_GUARD_CHECK_URL, MAX_PURCHASE_COUNT_LIMIT } from './settings/common.setting'
